...
if (true) {
	...
	SetPanelVisibility('u22','toggle','none',500);

	SetPanelVisibility('u7','toggle','none',500);

}
});
gv_vAlignTable['u19'] = 'center';gv_vAlignTable['u47'] = 'center';gv_vAlignTable['u45'] = 'top';gv_vAlignTable['u33'] = 'center';